...
public final class CycleStateComponent implements Component<ChunkStore> {

    @Nonnull
    public static final BuilderCodec<CycleStateComponent> CODEC =
            BuilderCodec.builder(CycleStateComponent.class, CycleStateComponent::new)
    ...
    private static ComponentType<ChunkStore, CycleStateComponent> componentType;

    public static void setComponentType(ComponentType<ChunkStore, CycleStateComponent> type) {
        componentType = type;
    }

    public static ComponentType<ChunkStore, CycleStateComponent> getComponentType() {
    ...
    public Component<ChunkStore> clone() {
        CycleStateComponent copy = new CycleStateComponent();
